...
2026-09-01 线上验收：代码提交 `a22bb70` 的 [校验工作流](https://github.com/Minkelxy/ningxia-tourism/actions/runs/33430697271) 与 [Pages 构建部署](https://github.com/Minkelxy/ningxia-tourism/actions/runs/33430696380) 均为 **success**；地图层级返回、列表清除筛选、手记清空筛选和行前清单重置已统一悬停、键盘聚焦与轻量位移反馈，并与全站内容入口状态保持一致。既有搜索、筛选、卡片、详情页操作、深色头图按钮及纯展示图层语义继续通过回归，已通过本地类型、规范、单元、内容、端到端、生产构建与 Lighthouse 校验。
