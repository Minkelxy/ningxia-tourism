...
2026-09-03 v0.3.112 发布复核：待 GitHub Actions 完成后回填代码提交、工作流编号与最终测试统计。景点主题、筛选面板、路线/五城比较区域、结果表格、路线卡片和关于本站方法卡片使用统一的渐进绘图与轻量墨线；减少动效设置下恢复静态内容与墨线，筛选、收藏、对比、横向浏览和链接行为不变。
