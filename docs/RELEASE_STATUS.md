...
2026-09-03 v0.3.119 发布复核：待 GitHub Actions 完成后回填最终代码提交、工作流编号与测试统计。路线筛选组合变化时，结果摘要、横向比较表、路线卡片与空结果按新的筛选结果重新挂载并渐进绘图；保留 URL 同步、筛选语义、比较表横向浏览、收藏和路线链接，减少动效设置下恢复静态结果。
