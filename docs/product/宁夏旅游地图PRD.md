...
> 当前实现快照（2026-08-25）：5 个城市、22 个公开景点、9 条路线、14 道美食、15 篇资料专题；首页与主要内容页已统一视觉语言，并接入明确标注的 AI 编辑插画示例。发布验收入口见 [RELEASE_STATUS.md](../RELEASE_STATUS.md)。
...
#### 2.2.4 美食目录
- **14 道特色美食**: 手抓羊肉、蒿子面、八宝茶、羊杂碎、辣糊糊等；美食页面的主题插画必须标注为非实拍
...
- **编辑插画边界**：AI 视觉示例只承担页面氛围和主题表达，不作为实景、菜品规格、商户或路线证据；来源记录统一维护在 `docs/content/IMAGE_PROVENANCE.md`
