...
> 当前实现快照已更新至 v0.3.123：首页山河绘图分层入场、首页路线结果绘图、地图区域入场、地图视口过渡、路线轨道与节点落印、地图层级图层重绘、景点与美食筛选结果重绘、路线筛选结果重绘、旅行手记筛选结果重绘、全站搜索结果重绘、区域聚焦墨线、选中点位墨线和公共反馈层共享轻量动效基线，筛选输入、全站搜索、地图控制、收藏列表、景点卡片、路线详情和行前指南继续共享统一的响应式触控与布局基线。
