...
> 当前实现快照（2026-09-01，v0.3.15）：5 个城市、22 个公开景点、9 条路线、14 道美食、15 篇资料专题；首页与主要内容页已统一视觉语言，筛选面板、导航、地图层级、清除筛选、卡片、次级目的地、阅读资料入口、说明页目录、详情页操作与深色头图按钮已统一悬停/键盘聚焦反馈，景点与美食配图优先使用可追溯的网络实拍或官方公开图片。发布验收入口见 [RELEASE_STATUS.md](../RELEASE_STATUS.md)。
