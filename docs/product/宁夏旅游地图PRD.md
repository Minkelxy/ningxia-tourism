...
> 当前实现快照（2026-09-01，v0.3.11）：5 个城市、22 个公开景点、9 条路线、14 道美食、15 篇资料专题；首页与主要内容页已统一视觉语言，筛选面板、导航、卡片、次级目的地与阅读资料入口已统一悬停/键盘聚焦反馈，景点与美食配图优先使用可追溯的网络实拍或官方公开图片。发布验收入口见 [RELEASE_STATUS.md](../RELEASE_STATUS.md)。
