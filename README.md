...
- **导航与结果区触控规范**：桌面端与移动端品牌首页、搜索、收藏和菜单入口统一保持至少 44px 触控热区（收藏入口隐藏文字后仍保持 44px 宽），景点、路线与美食结果区的清除筛选、搜索清空按钮、搜索快捷关键词、比较结果入口、资料目录和其他控件保持一致的尺寸与聚焦反馈
...
- **统一站点导航**：顶部导航、移动菜单与页脚“继续探索”共用同一组景点、美食、路线、指南、手记和五城入口，资料说明与建议入口单独分组；三处入口共享当前页面路径匹配，统一提供选中态与 `aria-current="page"`，内容卡片与城市/路线比较表名称入口保持至少 44px 触控热区
