...
当前发布快照为 v0.3.74；验收命令与数据规模见 [docs/RELEASE_STATUS.md](docs/RELEASE_STATUS.md)。

---

## ✨ 核心特性

- **自研 SVG 交互地图**：基于宁夏行政区划 GeoJSON，无第三方地图 SDK，支持缩放平移、五市高亮与键盘无障碍；懒加载占位与正式画布共享沙纸色视觉语言，区县图例支持键盘聚焦联动区域高亮，进入视口后再加载地图数据
