...
- **统一站点导航**：顶部导航、移动菜单与页脚“继续探索”共用同一组景点、美食、路线、指南、手记和五城入口，资料说明与建议入口单独分组；三处入口共享当前页面路径匹配，统一提供选中态与 `aria-current="page"`，内容卡片、城市/路线比较表名称入口、比较表“查看”操作入口以及路线详情停靠点名称入口保持至少 44px 触控热区
