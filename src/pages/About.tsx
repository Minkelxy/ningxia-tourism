  ...
  return (
    <>
      ...
      <div className="section-shell about-layout">
        ...
        <section className="source-directory"><div><p className="eyebrow">资料与反馈</p><h2>继续核对最新信息</h2></div><div><a className="source-link" href="https://whhlyt.nx.gov.cn/" target="_blank" rel="noreferrer">宁夏回族自治区文化和旅游厅 <ExternalLink aria-hidden="true" /></a><a className="source-link" href="https://www.shapotou.com/index.html" target="_blank" rel="noreferrer">沙坡头旅游官方网站 <ExternalLink aria-hidden="true" /></a><a className="source-link" href="https://github.com/Minkelxy/ningxia-tourism/blob/main/docs/CONTENT_AUDIT.md" target="_blank" rel="noreferrer">查看内容审计记录 <ExternalLink aria-hidden="true" /></a><a className="source-link" href="https://github.com/Minkelxy/ningxia-tourism/issues" target="_blank" rel="noreferrer">在 GitHub 提交勘误 <ExternalLink aria-hidden="true" /></a></div></section>
      </div>
    </>
  );
}
