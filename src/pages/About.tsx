...
export default function About() {
  return (
    <>
      ...
      <header className="page-hero compact-hero collection-hero"><div className="section-shell collection-hero-grid"><div><p className="eyebrow">关于本站</p><h1>让漂亮的旅行网站，<br />也对信息负责。</h1><p>这是一个开源、非官方的宁夏旅行规划项目。我们区分官方事实、规划建议与个人体验，也明确告诉你哪些信息仍需在出发前确认。</p></div><div className="collection-hero-visual"><ResponsiveImage src="/images/ai-samples/source-research-desk.webp" alt="AI 生成的地图、核对清单与放大镜主题插画，仅作关于页氛围示例" width="720" height="480" loading="eager" fetchPriority="high" sizes="(max-width: 768px) 100vw, 42vw" /><span>AI 视觉示例 · 非实景</span></div></div></header>
      <div className="section-shell about-layout">
        ...
        <section className="method-grid">
          ...
          <article><Image aria-hidden="true" /><h2>图片说明</h2><p>图片保留作者、许可与原始页面。不是景点实景的区域配图会明确标注；首页、景点、路线、美食与关于页的“AI 视觉示例”只表达旅行氛围，不代表实景、路线证据、菜品规格或具体商户。</p></article>
