...
export default function JournalDetail() {
  ...
  if (!entry || entry.status !== 'published') return <main className="full-state journal-missing"><SEO title="手记整理中 · 宁夏旅行地图" noIndex /><NotebookPen aria-hidden="true" /><p className="eyebrow">内容整理中</p><h1>这篇手记还没有公开</h1><p>真实经历和照片完成核对后才会发布。先回到旅行手记查看栏目说明。</p><Link to="/journal" className="btn-primary">返回旅行手记</Link></main>;
  ...
  return <>
    <SEO title={`${entry.title} · 旅行手记`} description={entry.excerpt} image={entry.cover.src} />
