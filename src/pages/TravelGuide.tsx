    ...
    <>
      ...
      <header className="guide-hero">
        <div className="section-shell guide-hero-grid">
          ...
          <div className="guide-hero-side"><div className="guide-hero-visual"><ResponsiveImage src="/images/attractions/shahu.webp" alt="沙湖湖泊、芦苇与沙丘实景" width="720" height="480" loading="eager" fetchPriority="high" sizes="(max-width: 768px) 100vw, 36vw" /><span>实景照片 · 来源见景点详情</span></div><dl className="guide-hero-summary"><div><dt>季节建议</dt><dd>4</dd></div><div><dt>路线天数</dt><dd>1—5</dd></div><div><dt>行前事项</dt><dd>{travelChecklist.length}</dd></div></dl></div>
        </div>
      </header>
