...
import { useCallback, useMemo, useRef, type CSSProperties, type KeyboardEvent as ReactKeyboardEvent } from 'react';
...
export default function Journal() {
  ...
  const resultKey = [type, city, tag, q.trim()].join('|');
  ...
  return <>
    ...
    <div className="section-shell journal-page">
      ...
      <div id="journal-results" key={`journal-results-${resultKey}`} role="tabpanel" aria-labelledby={`${type}-tab`}>
