...
export default function Journal() {
  ...
  return <>
    ...
    <header className="journal-hero"><div className="section-shell journal-hero-grid"><div><p className="eyebrow"><NotebookPen aria-hidden="true" /> 旅行手记</p><h1>地图之外，<br />留下走过与查过的细节。</h1><p>亲历游记与探店只记录真实发生的体验；旅行专题则整理公开资料，并明确来源、核对日期和适用边界。两种内容不会混在一起。</p></div><div className="journal-cover-stack" aria-hidden="true"><div className="journal-ai-visual"><ResponsiveImage src="/images/ai-samples/source-research-desk.webp" alt="" width="720" height="480" loading="eager" fetchPriority="high" sizes="(max-width: 768px) 100vw, 32vw" /></div><span className="journal-ai-badge">AI 视觉示例 · 非实景</span><span className="paper-note">亲历与资料<br /><strong>清楚分开</strong></span><span className="date-stamp">宁夏<br />手记</span></div></div></header>
