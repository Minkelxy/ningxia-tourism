...
export default function Journal() {
  ...
  return <>
    ...
    <main className="section-shell journal-page">
      <div className="journal-tabs" role="tablist" aria-label="手记类型"><button id="travel-tab" type="button" role="tab" aria-controls="journal-results" aria-selected={type === 'travel'} onClick={() => switchType('travel')}><BookOpenText aria-hidden="true" />个人游记</button><button id="food-tab" type="button" role="tab" aria-controls="journal-results" aria-selected={type === 'food'} onClick={() => switchType('food')}><Store aria-hidden="true" />探店记录</button></div>
