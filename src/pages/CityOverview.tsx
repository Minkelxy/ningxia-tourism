...
export default function CityOverview() {
  ...
  return (
    <>
      ...
      <header className="page-hero compact-hero collection-hero"><div className="section-shell collection-hero-grid"><div><p className="eyebrow"><MapPin aria-hidden="true" /> 五座城市 · 五种旅行气质</p><h1>宁夏不只有沙漠</h1><p>先比较停留时间、适合人群与交通衔接，再选择一座城市，理解它的历史、味道与旅行节奏。</p></div><div className="collection-hero-visual"><ResponsiveImage src="/images/attractions/ningxia-museum.webp" alt="宁夏博物馆建筑实景" width="720" height="480" loading="eager" fetchPriority="high" sizes="(max-width: 768px) 100vw, 42vw" /><span>实景照片 · 来源见景点详情</span></div></div></header>
