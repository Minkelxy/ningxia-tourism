...
export default function RouteRecommendation() {
  ...
  return (
    <>
      ...
      <header className="route-hero compact-hero collection-hero"><div className="section-shell collection-hero-grid"><div><p className="eyebrow"><Sparkles aria-hidden="true" /> {routes.length} 条经过整理的主题路线</p><h1>先决定有几天，<br />再决定怎么认识宁夏。</h1><p>路线不是必须照抄的清单，而是一套减少折返、保留弹性的地理顺序。票价、班次和营业安排请在出发前再次确认。</p></div><div className="collection-hero-visual"><ResponsiveImage src="/images/ai-samples/mountain-valley.webp" alt="AI 生成的宁夏山谷慢行主题插画，仅作路线页面氛围示例" width="720" height="480" loading="eager" fetchPriority="high" sizes="(max-width: 768px) 100vw, 42vw" /><span><Sparkles aria-hidden="true" /> AI 视觉示例 · 非实景</span></div></div></header>
