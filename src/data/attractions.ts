...
const published: Attraction[] = [
  ...
  {
    id: 'beiwudang', status: 'published', verificationLevel: 'verified', name: '北武当生态旅游区', cityId: 'shizuishan', locality: '大武口区', category: 'nature',
    coordinates: { lng: 106.344, lat: 39.044 },
    summary: '从大武口城区向贺兰山东麓进入森林公园、寿佛寺与山地沟谷，是石嘴山看生态修复、登高和认识贺兰山北段的一处综合入口。',
    highlights: ['贺兰山东麓山地景观', '森林公园与生态修复', '寿佛寺、地质与边塞文化'],
    visitInfo: {
      openingHours: '自治区文旅厅景区页显示常规开放时间为 08:00—17:00；冬季、防火期、极端天气和山地游线维护可能临时调整',
      ticketPrice: '自治区文旅厅景区目录显示参考门票 40 元；内部体验或临时活动如有单独收费，以当日公示为准',
      reservation: '官方页面暂未列出统一预约要求；团队活动、节庆徒步和山地体验建议提前联系景区确认',
      duration: '3—5 小时', bestSeason: '4—10 月；9—10 月适合留意红叶与登高活动',
